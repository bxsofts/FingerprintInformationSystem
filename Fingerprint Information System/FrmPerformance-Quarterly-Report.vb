...
Public Class frmQuarterlyPerformanceReport
    ...
    Private Sub frmPerformance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim headertext As String = frmQuarterlyPerformance.lblPeriod.Text
        ...
        For i = 2 To 4
            m = "Month" & (i - 1)
            t = IIf(frmQuarterlyPerformance.DataGridViewX1.Columns(i + 1).HeaderText <> m, frmQuarterlyPerformance.DataGridViewX1.Columns(i + 1).HeaderText, "")
            parms(i) = New ReportParameter(m, t)
        Next
        parms(5) = New ReportParameter("Place", FullDistrictName)
        parms(6) = New ReportParameter("PreviousMonth", frmQuarterlyPerformance.DataGridViewX1.Columns(2).HeaderText)
        parms(7) = New ReportParameter("PreviousQuarter", "PreviousQuarter")
        ReportViewer1.LocalReport.SetParameters(parms)
        Me.PerformanceBindingSource.DataSource = frmQuarterlyPerformance.PerformanceBindingSource.DataSource
    ...
    Private Sub ReportViewer1_Print(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles ReportViewer1.Print
        On Error Resume Next
        frmQuarterlyPerformance.AutoSaveQuarterlyPerformance()
    End Sub
