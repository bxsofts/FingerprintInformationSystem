...
Public Class frmAttendanceStmt
    ...
    Private Sub bgwAttendance_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bgwAttendance.DoWork
        Try
            ...
            Dim missing As Object = System.Reflection.Missing.Value
            Dim fileName As Object = "normal.dotm"
            bgwAttendance.ReportProgress(5)
            System.Threading.Thread.Sleep(200)
            Dim newTemplate As Object = False
            Dim docType As Object = 0
            Dim isVisible As Object = True
            bgwAttendance.ReportProgress(8)
            Dim WordApp As New Word.ApplicationClass()

            bgwAttendance.ReportProgress(10)
            ...
            bgwAttendance.ReportProgress(20)
            ...
            bgwAttendance.ReportProgress(25)
            ...
            bgwAttendance.ReportProgress(28)
            ...
            bgwAttendance.ReportProgress(30)
            ...
            bgwAttendance.ReportProgress(40)
            ...
            bgwAttendance.ReportProgress(50)
            ...
            bgwAttendance.ReportProgress(60)

            Dim d = Date.DaysInMonth(Year(args.d1), Month(args.d2))
            ...
            For i = 4 To columncount
                ...
                Next
                bgwAttendance.ReportProgress(60 + i)
            Next
            ...
            bgwAttendance.ReportProgress(97)
            System.Threading.Thread.Sleep(200)
            ...
            If Me.chkLetter.Checked Then GenerateCL(d1, d2)
