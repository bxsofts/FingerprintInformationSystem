...
#Region "DATAGRID SETTINGS"
    ...
    Public Sub SetDatagridFont()
        ...
        '  Me.FPADataGrid.Columns(10).CellTemplate.Style.Font = New Font("Rupee Foradian", 9, FontStyle.Regular)
...
#Region "SOC DATA ENTRY FIELDS SETTINGS"
    ...
    Private Sub cmbIdentifiedByOfficer_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbIdentifiedByOfficer.GotFocus
        If Me.cmbIdentifiedByOfficer.Text.Trim = vbNullString Then Me.cmbIdentifiedByOfficer.Text = Me.txtSOCOfficer.Text
    End Sub
...
#Region "SET PHOTOGRAPHER NAME"
    Private Sub LoadPhotographerName() Handles txtSOCPhotographer.GotFocus
        On Error Resume Next
        ' If txtSOCCPsDeveloped.Value = 0 Then Exit Sub
...
#Region "REPORTS"
    ...
    Sub ShowSOCReport()
        Try
            ...
            If Trim(Photographer) = "" Or Trim(Photographer).ToLower = "no photographer" Then Photographer = "............................"
            Photographer = "Sri. " & Photographer & ", Police Photographer"
            ...
            If CPD = 0 Then 'nil print
                BodyText = BodyText & "." & vbNewLine & vbTab & "It is intimated that no useful chance prints were obtained from the scene of crime. Hence no further action is pending with this office in this regard. This is for your information."
            End If
            ...
            If CPD = 1 Then 'one print
                ...
                If CPU = 1 Then
                    BodyText = BodyText & vbNewLine & vbTab & "It is intimated that the chance print is unfit for comparison. Hence no further action is pending with this office in this regard. This is for your information."
                End If

                If CPE = 1 Then
                    BodyText = BodyText & vbNewLine & vbTab & "It is intimated that the chance print is eliminated as the finger impression of the inmate. Hence no further action is pending with this office in this regard. This is for your information."
                End If
            ...
            If CPD > 1 And CPU = CPD And CPR = 0 Then 'all unfit
                BodyText = BodyText & " and developed " & ConvertNumberToWord(CPD) & " chance prints which were photographed by " & Photographer & vbNewLine & vbTab & "It is intimated that all the chance prints are unfit for comparison. Hence no further action is pending with this office in this regard. This is for your information."
            End If

            If CPD > 1 And CPE = CPD And CPR = 0 Then 'all eliminated

                BodyText = BodyText & " and developed " & ConvertNumberToWord(CPD) & " chance prints which were photographed by " & Photographer & vbNewLine & vbTab & "It is intimated that all the chance prints are eliminated as the finger impressions of inmates. Hence no further action is pending with this office in this regard. This is for your information."
            End If

            If CPD > 1 And CPU <> CPD And CPE <> CPD And CPR = 0 Then 'all eliminated or unfit

                BodyText = BodyText & " and developed " & ConvertNumberToWord(CPD) & " chance prints which were photographed by " & Photographer & vbNewLine & vbTab & "Out of the " & ConvertNumberToWord(CPD) & " chance prints developed from the scene of crime, " & ConvertNumberToWord(CPE) & IIf(CPE = 1, " chance print is eliminated as the finger impression of inmate", " chance prints are eliminated as the finger impressions of inmates") & " and " & ConvertNumberToWord(CPU) & IIf(CPU = 1, " chance print is unfit", " chance prints are unfit") & " for comparison. Hence no further action is pending with this office in this regard. This is for your information."
            ...
            If CPD = 1 Then
                Select Case ReportNature.ToLower
                    Case "awaiting photographs"
                        ...
                        BodyText = BodyText & vbNewLine & vbTab & "The comparison work of the chance print will be initiated on receipt of photographs of chance print from the Police Photographer and result of comparison will be intimated to you. This is for your information."

                    Case "interim"
                        BodyText = "The chance print in the above case was compared with the fingerprint slips of Active Criminals / MO Criminals recorded in this bureau and remains untraced. Further comparison is being continued in the DA Slips collection and the result will be intimated as and when search is completed. This is for your information."
                    Case "untraced"
                        BodyText = "The chance print developed from the scene of crime concerned in the above case remains untraced in the available records of this bureau. This is for your information."
                    Case "identification report - cob"
                        Dim receiver As String = ReportSentTo.Replace(vbCrLf, ",").ToUpper

                        BodyText = "ONE CHANCEPRINT DEVELOPED FROM THE SCENE OF CRIME IN CR.NO. " & cr & " U/S " & us & " of " & ps & " IS FOUND IDENTICAL WITH THE ------------ FINGER IMPRESSION OF ONE " & idas & "(.) HE IS PREVIOUSLY INVOLVED IN CR.NO. ----------- OF ---------------- P.S(.) DETAILED REPORT FOLLOWS(.)"
                        GenerateIdentificationCoB(BodyText, receiver)
                        Exit Sub
            ...
            Else
                Select Case ReportNature.ToLower
                    Case "awaiting photographs"
                        ...
                        BodyText = BodyText & vbNewLine & vbTab & "The comparison work of chance prints will be initiated on receipt of photographs of chance prints from the Police Photographer and result of comparison will be intimated to you. This is for your information."
                    ...
                    Case "untraced"
                        BodyText = "The chance prints developed from the scene of crime concerned in the above case remain untraced in the available records of this bureau. This is for your information."
                    Case "identification report - cob"

                        If CPID = 1 Then BodyText = "ONE OF THE CHANCEPRINTS DEVELOPED FROM THE SCENE OF CRIME IN CR.NO. " & cr & " U/S " & us & " of " & ps & " IS FOUND IDENTICAL WITH THE ------------ FINGER IMPRESSION OF ONE " & idas & "(.) HE IS PREVIOUSLY INVOLVED IN CR.NO. ----------- OF ---------------- P.S(.) DETAILED REPORT FOLLOWS(.)"
                        If CPID > 1 Then BodyText = ConvertNumberToWord(CPID) & " OF THE CHANCEPRINTS DEVELOPED FROM THE SCENE OF CRIME IN CR.NO. " & cr & " U/S " & us & " of " & ps & " ARE FOUND IDENTICAL WITH THE ------------ FINGER IMPRESSIONS OF ONE " & idas & "(.) HE IS PREVIOUSLY INVOLVED IN CR.NO. ----------- OF ---------------- P.S(.) DETAILED REPORT FOLLOWS(.)"
                        Dim receiver As String = ReportSentTo.Replace(vbCrLf, ",").ToUpper
                        GenerateIdentificationCoB(BodyText, receiver)
                        Exit Sub
                    Case "identification report - letter"
            ...
            Select Case ReportNature.ToLower
                ...
                Case "identification report - letter"
                    WordApp.Selection.TypeText(vbTab & "Sub:  Inspection of Scene of Crime – Identification of criminal through chance prints – report - reg.")
                Case Else
            ...
            If ReportNature.ToLower = "identification report - letter" Then
                ...
                WordApp.Selection.TypeParagraph()
                WordApp.Selection.TypeParagraph()
                WordApp.Selection.TypeText("Copy To:" & vbNewLine)
                WordApp.Selection.TypeText(vbTab & "District Police Chief, " & FullDistrictName & " with C/L" & vbNewLine)
                WordApp.Selection.TypeText(vbTab & "Director, Fingerprint Bureau, Thiruvananthapuram" & " with C/L" & vbNewLine)
    ...
    Private Sub GenerateIdentificationCoB(ByVal message As String, ByVal Receiver As String)
        ...
        WordApp.Selection.TypeText("INF:" & vbTab & "DIRECTOR, FPB, TVPM; DySP, DCRB, " & FullDistrictName & "; TI, -------------- RANGE" & vbNewLine)
    ...
    Private Sub GenerateIdentificationTemplates() Handles btnIdentifiedTemplateContextMenu.Click
        Try
            ...
            wdBooks("DIns").Range.Text = Me.SOCDatagrid.SelectedCells(2).FormattedValue.ToString
            wdBooks("Did").Range.Text = dtid
            wdBooks("Accused").Range.Text = Me.SOCDatagrid.SelectedCells(28).Value.ToString
        ...
        Try
            ...
            If idcount >= 1 Then
                For i = 2 To rows
                    ...
                    WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphLeft
                    WordApp.Selection.TypeText(Format(Me.FingerPrintDataSet.IdentifiedCases(i - 2).DateOfInspection, "dd/MM/yyyy"))
                    ...
                    WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphLeft
                    WordApp.Selection.TypeText(Format(Me.FingerPrintDataSet.IdentifiedCases(i - 2).IdentificationDate, "dd/MM/yyyy"))
    ...
    Private Sub ShowGistOfIdentifiedCases(ByVal Param As String)
        Try
            ...
            For i = 0 To idcount - 1
                ...
                WordApp.Selection.TypeText(i + 1 & ". No." & FileNo & "/" & ShortOfficeName & "/" & ShortDistrictName & vbNewLine)
                ...
                Dim dtinstr = Format(dtin, "dd/MM/yyyy")
                Dim dtid = Me.FingerPrintDataSet.IdentifiedCases(i).IdentificationDate
                Dim dtidstr = Format(dtid, "dd/MM/yyyy")
    ...
    Private Sub SuspectComparison()
        Try
            ...
            WordApp.Selection.TypeText(vbTab & "It is intimated that the " & IIf(CPD = 1, "chance print is", "chance prints are") & " NOT IDENTICAL with his/their finger impressions. This is for your information.")
            WordApp.Selection.TypeText(vbNewLine)
            WordApp.Selection.TypeParagraph()
            WordApp.Selection.TypeText(vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & vbTab & "Yours faithfully,")
            If boolUseTIinLetter Then
    ...
    Private Sub GenerateFPASlipForm(sender As Object, e As EventArgs) Handles btnFPAGenerateSlipFormContext.Click, btnFPAGenerateSlipForm.Click, btnFPABlankSlipForm.Click
        ...
        Try
            ...
            wdBooks("Office").Range.Text = UCase(FullOfficeName & ", " & FullDistrictName) & ", KERALA, INDIA"
            If BlankForm Then
                Dim dots As String = "..............................................."
...
#Region "ANNUAL STATISTICS"
    ...
    Private Sub ShowAnnualStatistics(ByVal Param As String)
        ...
        WordApp.Selection.TypeText(Me.DARegisterTableAdapter.CountDASlip(d1, d2))
        ...
        WordApp.Selection.TypeText(Me.CDRegisterTableAdapter.CountCD(d1, d2))
        ...
        WordApp.Selection.Font.Name = "Rupee Foradian"
        WordApp.Selection.Font.Size = 10
        WordApp.Selection.TypeText("` " & Me.FPARegisterTableAdapter.AmountRemitted(d1, d2) & "/-")
        ...
        Dim x As Integer = Me.SOCRegisterTableAdapter.ScalarQueryCPsIdentified(d1, d2)
        WordApp.Selection.TypeText(x)

        WordApp.Selection.Tables.Item(1).Cell(7, 2).Select()
        WordApp.Selection.TypeText("No. of  cases identified during the year")
        WordApp.Selection.Tables.Item(1).Cell(7, 3).Select()
        WordApp.Selection.TypeText(Me.SOCRegisterTableAdapter.ScalarQuerySOCsIdentified(d1, d2))
        WordApp.Selection.Tables.Item(1).Cell(8, 2).Select()
        ...
        WordApp.Selection.Tables.Item(1).Cell(9, 3).Select()
        WordApp.Selection.TypeText(Val(Me.SOCRegisterTableAdapter.ScalarQuerySearchContinuingSOCs(d1, d2, "")))
        ...
        WordApp.Selection.TypeText(vbNewLine & vbNewLine & vbNewLine & "IV. STAFF STRENGTH" & vbNewLine)
        WordApp.Selection.Font.Bold = 0
        Dim staffstrength As Integer = 3
        If Me.chkFPE2.Visible = True Then staffstrength += 1
        If Me.chkFPE3.Visible = True Then staffstrength += 1


        WordApp.Selection.Tables.Add(WordApp.Selection.Range, staffstrength + 1, 5)
        ...
        If chkTI.Visible = True Then
            WordApp.Selection.Tables.Item(1).Cell(2, 2).Select() 'name and designation
            WordApp.Selection.TypeText(Me.chkTI.Text.Replace("TI", "Tester Inspector"))
        ...
        If chkFPE1.Visible = True Then
            WordApp.Selection.Tables.Item(1).Cell(3, 2).Select() 'name and designation
            WordApp.Selection.TypeText(Me.chkFPE1.Text.Replace("FPE", "Fingerprint Expert"))
        ...
        If chkFPE2.Visible = True Then
            WordApp.Selection.Tables.Item(1).Cell(4, 2).Select() 'name and designation
            WordApp.Selection.TypeText(Me.chkFPE2.Text.Replace("FPE", "Fingerprint Expert"))
            WordApp.Selection.Tables.Item(1).Cell(3, 3).Select() 'Strength sanctioned
            WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphCenter
            WordApp.Selection.TypeText("2")
            WordApp.Selection.Tables.Item(1).Cell(3, 4).Select() 'Strength existing
        ...
        If chkFPE3.Visible = True Then
            WordApp.Selection.Tables.Item(1).Cell(5, 2).Select() 'name and designation
            WordApp.Selection.TypeText(Me.chkFPE3.Text.Replace("FPE", "Fingerprint Expert"))
            WordApp.Selection.Tables.Item(1).Cell(3, 3).Select() 'Strength sanctioned
            WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphCenter
            ...
            WordApp.Selection.Tables.Item(1).Cell(5, 3).Select() 'Strength sanctioned
            WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphCenter
            WordApp.Selection.TypeText("-")
            WordApp.Selection.Tables.Item(1).Cell(5, 4).Select() 'Strength existing
            WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphCenter
            WordApp.Selection.TypeText("-")
            WordApp.Selection.Tables.Item(1).Cell(5, 5).Select() 'Vacancies
            WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphCenter
            WordApp.Selection.TypeText("-")
        End If

        Dim fpsposition = 4
        If chkFPE2.Visible Then fpsposition += 1
        If chkFPE3.Visible Then fpsposition += 1

        If chkFPS.Visible = True Then
            WordApp.Selection.Tables.Item(1).Cell(fpsposition, 2).Select() 'name and designation
            WordApp.Selection.TypeText(Me.chkFPS.Text.Replace("FPS", "Fingerprint Searcher"))
            WordApp.Selection.Tables.Item(1).Cell(fpsposition, 3).Select() 'Strength sanctioned
            WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphCenter
            WordApp.Selection.TypeText("1")
            WordApp.Selection.Tables.Item(1).Cell(fpsposition, 4).Select() 'Strength existing
            WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphCenter
            WordApp.Selection.TypeText("1")
            WordApp.Selection.Tables.Item(1).Cell(fpsposition, 5).Select() 'Vacancies
            WordApp.Selection.Paragraphs.Alignment = Word.WdParagraphAlignment.wdAlignParagraphCenter
            WordApp.Selection.TypeText("-")
        Else
            WordApp.Selection.Tables.Item(1).Cell(fpsposition, 2).Select() 'name and designation
        ...
        WordApp.Selection.Tables.Item(1).Cell(fpsposition, 5).Select()
        WordApp.Selection.GoToNext(Word.WdGoToItem.wdGoToLine)
        WordApp.Selection.Font.Bold = 1
        '------------------------------ DETAILS OF IDENTIFIED CASES -----------------------

        Me.IdentifiedCasesTableAdapter1.FillByIdentifiedCases(FingerPrintDataSet.IdentifiedCases, d1, d2)
        'Me.IdentifiedCasesTableAdapter1.Fill(FingerPrintDataSet.IdentifiedCases)
        Dim idcount = Me.FingerPrintDataSet.IdentifiedCases.Count
        Dim rows = idcount + 1
        If rows = 1 Then rows = 2
