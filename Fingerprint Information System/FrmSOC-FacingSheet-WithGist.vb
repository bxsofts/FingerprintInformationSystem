...
Public Class frmSOCFacingSheetWithGist
    ...
    Private Sub InitializeReport() Handles Me.Load
        ...
        boolFacingSheetWithGistIsVisible = True
    ...
    Private Sub PrintReport() Handles btnPrint.Click
        On Error Resume Next
        If Me.ReportViewer1.LocalReport.GetTotalPages > 1 Then
            MessageBoxEx.Show("FOR YOUR INFORMATION: The report contains 'Gist of the Case' and so will need " & Me.ReportViewer1.LocalReport.GetTotalPages & " pages for printing.", strAppName, MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    ...
    Private Sub ResetFormVisibleStatus() Handles Me.FormClosed
        On Error Resume Next
        boolFacingSheetWithGistIsVisible = False
    End Sub
    ...
    Private Sub OpenInWord() Handles btnOpenInWord.Click
        Try
            ...
            WordApp.Selection.Font.Bold = 1
            WordApp.Selection.Font.Underline = Word.WdUnderline.wdUnderlineSingle
            WordApp.Selection.TypeText("Gist of the case" & vbNewLine)
            WordApp.Selection.Font.Bold = 0
            WordApp.Selection.Font.Underline = Word.WdUnderline.wdUnderlineNone
            WordApp.Selection.TypeText(vbTab & Me.FingerPrintDataSet.SOCRegister(0).Gist)
